...
export const formatUserData = (data) => {
    const { user_id, user_name, full_name, avatar, user_email, created_at, bio, website_link, phone, followers_count, following_count, posts_count, is_following, is_subscribed, is_email_verified } = data;
