    ...
    return (
        <div className="">
            <div className="flex justify-between cursor-pointer hover-highlight px-3 py-2 rounded-md text-sm" onClick={() => setShowSub(prev => !prev)}>
                <div className="flex">
                    {showSub ? <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down"><path d="m6 9 6 6 6-6" /></svg> :
