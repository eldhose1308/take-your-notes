                        ...
                        <Link to={userDetailRoute} className='cursor-pointer group-hover'>
                            <div className="flex mb-2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-secondary px-3 space-y-1 text-xs">134 followers</p>
                                </div>
                            </div>
                        </Link>
                    </div>
                    <div className="flex flex-col mb-2">
                        {!isCurrentUserDetail && <div className="flex bg-custom text-accent hover-text-custom hover-accent text-xs my-2 mx-1 p-2 px-2 cursor-pointer rounded-md">
