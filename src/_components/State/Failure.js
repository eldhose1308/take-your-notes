    ...
    return (
        <div className='flex flex-col w-full items-center my-12'>
            ...
            <div className="flex flex-col items-center my-4 text-center">
                <Typography size='lg' type='h2'>Oh no!</Typography>
                <Typography variant='secondary' size='sm' textVariant='default'>Sometimes, all it takes is a quick refresh!</Typography>
                <Typography variant='secondary' size='sm' textVariant='default'>If this page isn't what you expected, you can return to the main menu.</Typography>
            </div>
        </div>
    )
}
