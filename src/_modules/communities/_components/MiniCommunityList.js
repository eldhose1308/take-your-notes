                ...
                <Flex justifyContent='spaceBetween' className='px-3 py-1 border-b border-another bg-default rounded-md'>
                    ...
                    <Button width='none' variant='ghost' size='xs' onClick={toggleCard}>
                        {isCardOpen ?
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-eye"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" /><circle cx="12" cy="12" r="3" /></svg>
                        }
                    </Button>
                </Flex>
            </CardTitle>
